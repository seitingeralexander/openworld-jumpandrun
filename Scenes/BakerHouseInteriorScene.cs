...
{
    /// <summary>
    /// Interior scene for Baker's house. Demonstrates building interior scenes.
    /// </summary>
    public class BakerHouseInteriorScene : Scene
    {
        public override string SceneId => "BakerHouseInterior";
        ...
        public BakerHouseInteriorScene(GraphicsDevice graphicsDevice, ContentManager content)
        ...
        private void CheckExitDoor()
        {
            ...
            {
                // Return to TownScene at the house entrance (home_01)
                var homeLocation = Context.Town.GetLocation("home_01");
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            // UI layer
            spriteBatch.Begin();
            DebugFont.DrawString(spriteBatch, "Baker's Home Interior", new Vector2(10, 10), Color.White);
            spriteBatch.End();
        }
    }
}
